...
SQL is a language used in Relational Databases to navigate and manupulate them.

- [x] Why do tables need a `primary key`?
A primary key is what identifies each row.
...
Intermediary table and a compound key.
